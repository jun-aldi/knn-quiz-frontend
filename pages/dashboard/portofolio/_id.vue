              ...
              <div v-for="photo in portofolios.photo" class="card md:min-h-[400px]">
                <div class="m-auto text-center">
                  ...
                  <div class="grid justify-center grid-cols-2 gap-4">
                    <button type="button" class="p-2 bg-yellow-200 rounded-xl text-red btn btn-warning">
                      Edit
                    </button>
                    <button type="button" class="p-2 bg-red-200 rounded-xl text-red btn btn-danger"
