  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    >
      <div class="flex items-center justify-between gap-4">
        ...
        <div class="text-[32px] font-semibold text-dark">Heroes Section</div>
      </div>
    </section>
      ...
      >
        ...
        <div class="px-6 py-4 text-left modal-content">
          <div class="flex items-center justify-between pb-3">
            <p class="text-2xl font-bold">Add Heroes</p>
        ...
        <div class="card !gap-y-10">
          <div class="flex items-center justify-between">
            <div>
              ...
              <div  v-if="heroes" class="text-[32px] font-bold text-brightYellow mt-[6px]">{{ totalHeroes}}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="pt-[50px]">
      ...
      <div class="mb-[30px]">
        <div class="flex items-center justify-between gap-6">
          <div>
            <div class="text-xl font-medium text-dark">Heroes</div>
